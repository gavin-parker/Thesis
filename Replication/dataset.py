        ...
        for environment in os.listdir(location):
            ...
            for object in os.listdir("{}/{}".format(location, environment)):
                ...
                if not object.endswith(".exr"):
                    ...
                    resized_img = tf.map_fn(lambda x: tf.image.resize_image_with_crop_or_pad(x, 512, 512), x_image)
                    resized_norm = tf.map_fn(lambda x: tf.image.resize_image_with_crop_or_pad(x, 512, 512), x_norm)
