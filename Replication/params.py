...
tf.app.flags.DEFINE_float('learning-rate', 3.2e-9, 'Learning Rate. (default: %(default)d)')
...
tf.app.flags.DEFINE_string('train-dir', "/mnt/black/MultiNatIllum/data/multiple_materials_single_object/singlets/",
