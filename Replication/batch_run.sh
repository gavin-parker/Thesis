...
python main.py --dematerial --log-dir='/mnt/storage/scratch/gp14958/dm_logs' --batch-size=32 learning-rate=3.2e-9 --train-dir='/mnt/storage/scratch/gp14958/MultiNatIllum/data/multiple_materials_single_object/singlets/'
