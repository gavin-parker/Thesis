...
Wehrwein et al. & Outside \& clear & Lambertian \checkmark & X \\
...
\caption{An example LDR panorama, with dark and light exposures extracted the predicted HDR environment. \textit{Credit - Google}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[height=8cm]{images/Stereo}
