...
\begin{figure}
\centering
\includegraphics[height=5cm]{images/examples/gt}\\
    \vspace{0.5cm}
\includegraphics[height=5cm]{images/examples/basic}
...
\centering
\begin{tabular}{|c|c|c|c|}
	Input & Ground Truth Environment & Predicted Environment & SSIM Score \\
 \includegraphics[width=2cm]{images/validation/516}&
 \includegraphics[width=2cm]{images/validation/516_gt}&
 \includegraphics[width=2cm]{images/validation/516_pred}&
  0.157 \\
 \includegraphics[width=2cm]{images/validation/332}&
 \includegraphics[width=2cm]{images/validation/332_gt}&
 \includegraphics[width=2cm]{images/validation/332_pred}&
  0.002 \\
...
Another more novel approach would be to take inspiration from \footcite{http://www.cs.wm.edu/~ppeers/showPublication.php?id=Xia:2016:RSS}, where the geometry, lighting and material estimations are treated as seperate problems and refined.
